...
export const SAMPLE_PLACES: Place[] = [
  ...
  },
  {
    ...
    reviews: 512,
    phone: "051-555-7763",
    image: require("../../assets/jobang_nakji.jpg"),
  ...
  },
  {
    ...
    reviews: 380,
    phone: "070-8703-3603",
    image: require("../../assets/seohui_bakery.png"),
  ...
  {
    id: "f16",
    name: "피쉐프코리아 빵장수쉐프 (장기점)",
    mainType: "food",
    category: "bakery",
    categoryLabel: "베이커리/명장빵",
    location: "대구 달서구 본리동",
    address: "대구 달서구 본리동 357-1",
    roadAddress: "대구 달서구 대명천로 235",
    latitude: 35.8398,
    longitude: 128.5375,
    rating: 4.8,
    reviews: 940,
    phone: "053-287-0120",
    image: require("../../assets/bbangjangsu_chef.jpg"),
    tags: ["빵장수단팥빵", "생크림단팥빵", "마늘바게트", "탕종식빵", "대구빵지순례", "50%쿠폰적립"],
    distance: "약 98.0km",
    hotelDistanceInfo: "거리: 약 98.0km · 경부/중앙고속도로 이동 경유 코스",
    operatingHours: "08:00 ~ 22:00 · 연중무휴",
    todayHours: "08:00 - 22:00",
    holiday: "연중무휴 (매주 화요일 50% 쿠폰 적립데이)",
    highlight: "대한민국 제과기능장 박기태 쉐프의 명품 베이커리 본점! 365일 생크림 케이크 & 생크림단팥빵 성지",
    reviewSummary: [
      "생크림단팥빵과 마늘바게트, 탕종식빵이 시그니처이며 빵 본연의 풍미가 예술입니다.",
      "매주 화요일 50% 쿠폰 적립데이 행사로 가성비가 훌륭하며 건물 측면/지하에 주차장(약 20대) 완비.",
      "365일 생크림/과일 1호 케이크 23,000원 갓성비로 여행 선물 및 포장으로 최고입니다.",
    ],
    menuItems: [
      {
        name: "생크림 단팥빵 / 빵장수 단팥빵",
        price: "3,300원",
        isSignature: true,
        description: "부드럽고 꽉 찬 우유 생크림과 달콤한 팥앙금의 조화",
      },
      {
        name: "마늘 바게트",
        price: "5,800원",
        isSignature: true,
        description: "촉촉하고 알싸한 마늘 소스가 듬뿍 배어있는 바게트",
      },
      {
        name: "상하이 버터떡 / 탕종 식빵",
        price: "4,500원",
        isSignature: false,
        description: "쫄깃하고 고소한 버터 풍미의 디저트 떡 & 탕종 식빵",
      },
      {
        name: "365일 생크림·과일 케이크 1호",
        price: "23,000원",
        isSignature: true,
        description: "100% 동물성 생크림과 신선한 계절 과일이 듬뿍 들어간 케이크",
      },
      {
        name: "에그타르트 & 스콘류",
        price: "3,500원",
        isSignature: false,
        description: "바삭한 페이스트리와 부드러운 커스터드 크림",
      },
    ],
    reviewsList: [
      {
        ...
        date: "2일 전",
        rating: 5,
        content: "대구 빵지순례 필수 코스! 생크림단팥빵 크림이 진짜 터질 듯이 들어있고 전혀 느끼하지 않아요. 마늘바게트도 인생 바게트입니다.",
      },
      {
        id: "r_f16_2",
        author: "김태리",
        date: "5일 전",
        rating: 5,
        content: "화요일에 방문해서 50% 쿠폰 적립 받았습니다. 케이크 1호가 23,000원인데 퀄리티는 호텔 베이커리급이에요.",
      },
      {
        id: "r_f16_3",
        author: "이동욱",
        date: "1주 전",
        rating: 5,
        content: "부산 내려가는 길에 경유해서 빵 포장해갔는데 가족들 모두 대만족했습니다. 주차장도 편하고 직원분들도 친절해요.",
      },
      {
        id: "r_f16_4",
        author: "아이유",
        date: "2주 전",
        rating: 5,
        content: "상하이 버터떡이랑 탕종식빵 쫄깃함이 대박이에요. 아침 8시부터 오픈해서 모닝 빵 사러 가기 좋습니다.",
      },
      {
        id: "r_f16_5",
        author: "정우성",
        date: "3주 전",
        rating: 4,
        content: "피쉐프 박기태 명장 베이커리답게 빵 퀄리티가 남다릅니다. 대구 달서구 오면 무조건 들러야 할 명소입니다.",
      },
    ],
  },
  ...
  },
  {
    ...
    mainType: "attraction",
    category: "cafe",
    categoryLabel: "베이커리/명장소금빵",
    location: "부산 기장군 일광읍",
    address: "부산 기장군 일광읍 칠암리 160-5",
    roadAddress: "부산 기장군 일광읍 칠암1길 7-10",
    latitude: 35.2678,
    longitude: 129.2562,
    rating: 4.9,
    reviews: 4120,
    phone: "051-727-1200",
    image: require("../../assets/chilam_sagye.png"),
    tags: ["이흥용명장", "소금빵성지", "기장오션뷰카페", "칠암사계", "베이커리대형카페"],
    distance: "약 20.0km",
    hotelDistanceInfo: "거리: 약 20.0km · 차량 약 30~35분 (기장 해안도로)",
    operatingHours: "10:00 ~ 21:00 (라스트오더 20:30) · 연중무휴",
    todayHours: "10:00 - 21:00",
    holiday: "연중무휴",
    highlight: "대한민국 제과명장 이흥용의 베이커리 오션뷰 대형 카페! 버터 풍미 가득한 소금빵의 성지",
    reviewSummary: [
      "대한민국 명장 이흥용 제과장의 소금빵 베이커리 대형 카페 [20:05]",
      "소금빵(대표 메뉴): 겉은 바삭하고 속은 촉촉한 버터 풍미 가득한 전국 1등 소금빵 [20:05]",
      "기장 일광 바다가 펼쳐지는 감각적인 건축미와 중정 오션뷰 [19:31, 20:05]",
    ],
    menuItems: [
      {
      ...
      {
        name: "칠암블렌드 아메리카노 (블랙실크)",
        price: "6,000원",
        description: "고소하고 묵직한 바디감의 칠암사계 시그니처 원두",
      },
      {
        name: "칠암 바닐라빈 라떼",
        price: "7,000원",
        description: "마다가스카르산 천연 바닐라빈을 숙성시켜 풍미를 극대화한 라떼",
      },
    ],
    reviewsList: [
          {
  ...
  },
  {
    ...
    reviews: 3890,
    phone: "051-247-9900",
    image: require("../../assets/songdo_cable_car.jpg"),
  ...
  },
  {
    ...
    reviews: 2150,
    phone: "051-607-6361",
    image: require("../../assets/igidae_park.png"),
